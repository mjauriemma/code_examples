 ...
 *     is logically distributed cyclicly.  Vectors are logically
 *     distributed cyclicly.  This version uses a random number 
 ...
 *
 * Compile:  
 *    gcc -g -Wall -o pth_mat_vect_rand_cyc pth_mat_vect_rand_cyc.c -lpthread
 * Usage:
 *    ./pth_mat_vect_rand_cyc <thread_count> <m> <n>
 *
 * Notes:  
 ...
 *         and product.
 *
 * Time: The cyclic distribution ran faster than the block distribution.
 */
