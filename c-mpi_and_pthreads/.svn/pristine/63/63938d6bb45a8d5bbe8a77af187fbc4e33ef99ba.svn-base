 ...
 *           the threads
 *
 * Runtimes with 4 threads and 1000000 locks/unlocks:
 *
 * many_mutexes: 1.144363 seconds (Average of 3 runs)
 * many_semaphores: 4.359744 seconds (Average of 3 runs)
 */
 ...
 * Purpose:    Repeatedly lock and unlock a semaphore to determine 
